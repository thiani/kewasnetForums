...
# python manage.py runserver --settings=kewasnetForumProject.settings.prod_local
...
SECRET_KEY = os.environ.get("SECRET_KEY", 'django-insecure-_v*-t#)rd75bu5m6=5!qk^+d#n##osmmr3+()fd*^kk&mi)vny')
